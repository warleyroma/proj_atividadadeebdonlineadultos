...
const BANCO = {
  ...
  anagrama: [
    ...
    { embaralhado: "AACAA", resposta: "CANAA" },
  ...
  forca: [
    ...
    { dica: "Terra prometida", resposta: "CANAA" },
  ...
  soletrar: ["ABRAAO", "FE", "DEUS", "CHAMADO", "CANAA", "PROMESSA", "ALTAR", "OBEDIENCIA", "FOME", "EGITO", "BENCAO", "ALIANA"],
